...
class PEAR
{
    ...
    * @param  string $public    The publiciable to retrieve.
    * @return mixed   A reference to the publiciable. If not set it will be
    *                 auto initialised to NULL.
    */
    public function &getStaticProperty($class, $public)
    {
        static $properties;
        if (!isset($properties[$class])) {
            $properties[$class] = array();
        }
        if (!array_key_exists($public, $properties[$class])) {
            $properties[$class][$public] = null;
        }
        return $properties[$class][$public];
    }
    ...
    /**
    * Use this public function to register a shutdown method for static
    * classes.
    *
    * @access public
    * @param  mixed $func  The public function name (or array of class/method) to call
    ...
    */
     ...
     *        to be the callback public function or method.  A callback
     *        public function is a string with the name of the function, a
     ...
     *                  parameter specifies the callback public function or
...
class PEAR_Error
{
     ...
     * PEAR_ERROR_CALLBACK, the callback public function or object/method
     * tuple.
     *
     ...
     *
     * @return mixed callback public function or object/method array
     * @access public
     */
