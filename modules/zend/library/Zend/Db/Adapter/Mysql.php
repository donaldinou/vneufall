<?php
/**
 * Acreat Web Technologie
 *
 * Classe d'adaptateur DB Zend Framework pour mysql
 *
 * @category   Zend
 * @package    Zend_Db
 * @subpackage Adapter
...
class Zend_Db_Adapter_Mysql extends Zend_Db_Adapter_Abstract
{
    ...
    protected function _connect()
    {
        ...
        if ($this->_connection === false || mysql_errno($this->_connection)) {
            /**
             * @see Zend_Db_Adapter_Mysqli_Exception
             */
            require_once 'Zend/Db/Adapter/Mysqli/Exception.php';
            throw new Zend_Db_Adapter_Mysqli_Exception(mysql_errno($this->_connection));
        }
    }
