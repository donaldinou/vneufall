...
$tinybrowser['path']['image'] = '/Drupal6/sites/helios.PaysLiffre/files/image/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
